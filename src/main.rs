...
fn main() {
    ...
    let text = "I sat up and said 'The dog is dead.' ' I'd got that far,' he said. I said, 'I think someone killed the dog.' 'How old are you?’ he asked. I didn't answer. Mr. McDonald";
